...
write (*,*) 'An energy eigenvalue of zero means the value was not found in the interval'
write (*,*) 'A boundary violation of -1.0 means an eigenvalue was not found in the interval'
write (4,'(4g24.16)') 'Even Eigenvalue:', roots(1), 'Even Boundary Violation:', violation(1)
write (4,'(4g24.16)') 'Odd Eigenvalue:', roots(2), 'Odd Boundary Violation:', violation(2)
